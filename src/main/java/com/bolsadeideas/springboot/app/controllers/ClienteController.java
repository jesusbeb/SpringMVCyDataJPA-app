...
public class ClienteController {
	...
	/////Metodo del tipo get con una url, El .+ permite que Spring no borre o trunque la extension del archivo (.jpg, png, etc.)
	...
	public ResponseEntity<Resource> verFoto(@PathVariable String filename){
		...
		//implementamos el metodo load de la clase service y le pasamos el filename
		//usamos try y catch en caso de que esta mal formada la url
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model, 
		...
		if(!foto.isEmpty()) {
			...
			if(cliente.getId() != null 
				...
				//Llamamos al metodo de la clase Service y pasamos el nombre del archivo
